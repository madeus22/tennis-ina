...
public class SessionController implements Serializable {
    ...
    @EJB private fr.ina.tennis.SessionFacade ejbFacade;
    ...
    public List<Session> getItems() {
        //if (items == null) {
            items = getFacade().getRollingWeekSessions();
        //}
        return items;
    }
    ...
    public Session getSession(java.lang.Integer id) {
    ...
    public static class SessionControllerConverter implements Converter {
        ...
        public String getAsString(FacesContext facesContext, UIComponent component, Object object) {
            ...
            if (object instanceof Session) {
                ...
                return getStringKey(o.getIdsession());
            } else {
